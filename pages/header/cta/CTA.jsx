  ...
  return (
    <Box bgcolor="#E5EDF1" sx={{ borderRadius: '16px', margin: '21px', marginTop: '35px', padding: '5px' }}>
      ...
      <List>
        ...
        <ListItem sx={{ display: 'list-item', pl: 4 }}><b>March, 2023:</b> <a href='https://petsymposium.org/popets/2023/popets-2023-0078.pdf' target="_blank" rel="noreferrer" style={{textDecoration: 'underline', color: 'black'}}> Paper</a> on Membership Inference and Model Updates was accepted to <i>PETS 2023</i></ListItem>
      </List>
    </Box>
  )
}
