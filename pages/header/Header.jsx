    ...
    <Container id='home' align='center'>
      <Grid container display={(isMobile) ? 'block' : 'flex'} direction={(isMobile) ? 'column' : "row"} justifyContent="center" paddingTop={12}> 
        ...
        <Grid item md={7} textAlign="left">
          ...
          <p align="left">
            My primary academic interests lie in trustworthy/adversarial machine learning, and I am currently focused on researching solutions for people affected by AI/ML systems.
          </p>
          <p>
